...
public class TaskTestSamples {
    ...
    public static Task getTaskSample1() {
        return new Task().id(1L).title("title1").description("description1").storyPoints(1).sequenceNo(1);
    }

    public static Task getTaskSample2() {
        return new Task().id(2L).title("title2").description("description2").storyPoints(2).sequenceNo(2);
    }
