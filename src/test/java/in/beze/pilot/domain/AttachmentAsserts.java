...
public class AttachmentAsserts {
    ...
    public static void assertAttachmentUpdatableFieldsEquals(Attachment expected, Attachment actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getFileAttachment()).as("check fileAttachment").isEqualTo(actual.getFileAttachment()))
            .satisfies(e ->
                assertThat(e.getFileAttachmentContentType())
                    .as("check fileAttachment contenty type")
                    .isEqualTo(actual.getFileAttachmentContentType())
            )
