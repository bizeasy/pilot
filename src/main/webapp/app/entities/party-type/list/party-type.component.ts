...
import { EntityArrayResponseType, PartyTypeService } from '../service/party-type.service';
...
export class PartyTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPartyType): number => this.partyTypeService.getPartyTypeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.partyTypes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPartyType[] | null): IPartyType[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.partyTypeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
