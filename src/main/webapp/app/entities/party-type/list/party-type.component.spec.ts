...
import { sampleWithRequiredData } from '../party-type.test-samples';
...
describe('PartyType Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to partyTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPartyTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPartyTypeIdentifier).toHaveBeenCalledWith(entity);
