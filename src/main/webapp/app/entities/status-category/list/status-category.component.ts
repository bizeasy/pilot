...
import { EntityArrayResponseType, StatusCategoryService } from '../service/status-category.service';
...
export class StatusCategoryComponent implements OnInit {
  ...
  trackId = (_index: number, item: IStatusCategory): number => this.statusCategoryService.getStatusCategoryIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.statusCategories = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IStatusCategory[] | null): IStatusCategory[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.statusCategoryService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
