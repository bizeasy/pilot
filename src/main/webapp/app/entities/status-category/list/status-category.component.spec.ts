...
import { sampleWithRequiredData } from '../status-category.test-samples';
...
describe('StatusCategory Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to statusCategoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStatusCategoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStatusCategoryIdentifier).toHaveBeenCalledWith(entity);
