...
import { sampleWithRequiredData } from '../party.test-samples';
...
describe('Party Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to partyService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPartyIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPartyIdentifier).toHaveBeenCalledWith(entity);
